...
class TestMockServiceRole:
    """Test Mock Service role functionality."""
    
    def test_mock_service_running(self, host, is_mock_service_server):
    ...
    def test_mock_service_port_listening(self, host, is_mock_service_server):
        """Test that Mock Service is listening on the correct port."""
        if is_mock_service_server:
            socket = host.socket(f"tcp://0.0.0.0:{MOCK_SERVICE_PORT}")
            assert socket.is_listening
    
    def test_mock_service_user_and_group(self, host, is_mock_service_server):
    ...
    def test_mock_service_files_and_permissions(self, host, is_mock_service_server):
    ...
    def test_mock_service_systemd_configuration(self, host, is_mock_service_server):
    ...
    def test_mock_service_endpoints(self, host, is_mock_service_server):
    ...
    def test_mock_service_metrics_format(self, host, is_mock_service_server):
